...
RcppExport SEXP _ARGmetrics_updateDistancesWithCombinations(SEXP length_root_distancesSEXP, SEXP topological_root_distancesSEXP, SEXP left_partitionSEXP, SEXP right_partitionSEXP, SEXP index_offsetsSEXP, SEXP distance_to_rootSEXP, SEXP edges_to_rootSEXP) {
BEGIN_RCPP
...
static const R_CallMethodDef CallEntries[] = {
    {"_ARGmetrics_updateDistancesWithCombinations", (DL_FUNC) &_ARGmetrics_updateDistancesWithCombinations, 7},
    {NULL, NULL, 0}
};

RcppExport void R_init_ARGmetrics(DllInfo *dll) {
